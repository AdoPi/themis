...
class UserScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_score" do
    assert_difference('UserScore.count') do
      post user_scores_url, params: { user_score: { leaderboard_id: @user_score.leaderboard_id, points: @user_score.points, user_name: @user_score.user_name } }
    end
  ...
  test "should update user_score" do
    patch user_score_url(@user_score), params: { user_score: { leaderboard_id: @user_score.leaderboard_id, points: @user_score.points, user_name: @user_score.user_name } }
