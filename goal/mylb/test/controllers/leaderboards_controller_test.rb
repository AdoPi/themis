...
class LeaderboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leaderboard" do
    assert_difference('Leaderboard.count') do
      post leaderboards_url, params: { leaderboard: { company_name: @leaderboard.company_name, name: @leaderboard.name } }
    end
  ...
  test "should update leaderboard" do
    patch leaderboard_url(@leaderboard), params: { leaderboard: { company_name: @leaderboard.company_name, name: @leaderboard.name } }
